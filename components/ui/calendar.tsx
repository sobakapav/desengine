...
function buildCalendarRangeClassNames(defaultClassNames: ReturnType<typeof getDefaultClassNames>) {
  return {
    range_start: cn(
...
function buildCalendarClassNames({
  ...
  return {
    ...
    ...buildCalendarRangeClassNames(defaultClassNames),
    ...classNames,
  }
}
...
function CalendarChevron({ className, orientation, ...props }: React.ComponentProps<typeof ChevronLeftIcon> & { orientation?: "up" | "down" | "left" | "right" }) {
  if (orientation === "left") {

      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(18rem,1fr)]">
        ...
        <div className="space-y-2 rounded-md border p-4">
          ...
          <p className="text-muted-foreground whitespace-pre-wrap">
            Единый цикл «сделать решение, потом пройти проверку» завершён для всей задачи. Можно вернуться к списку задач или снова открыть работу и посмотреть финальное состояние файлов.
          </p>
        </div>
      </div>

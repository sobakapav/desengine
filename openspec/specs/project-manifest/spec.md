...
Система SHALL иметь внешний `project manifest`, который выражает проект как переносимый пакет пользовательской работы, а не только как browser-local runtime state.

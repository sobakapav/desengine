...
- Что из родительского change уже решено: `focus-domain` уже держит стратегию доменных сущностей; idea-слой уже зафиксировал связь project, workflow и предмета работы.
...
- Что входит в этот change: producer-рамка workflow как процесса, схема связи с project/subject/workbench, readiness criteria и tactical parent для downstream workflow-линии.
...
- Понятна связь с Workbench и предметом работы.

...
- **AND** project page показывает этот компонент как часть активной линии работы
- **AND** пользователь не покидает project surface ради отдельной побочной сущности

...
- Что должен изменить этот change: producer full responsibility contract
...
- [заполнить]
- [заполнить]
- Какие ещё файлы и спецификации обязательны к чтению для fix-producer-full-responsibility-contract: [заполнить]

...
Система SHALL описывать работу над созданием React-компонента по картинке через канонический workflow, а не через прямое отождествление workflow step с текущим уровнем лаборатории.
...
- **AND** coordinator step может использовать legacy runtime/level progress как internal bridge без миграции storage
...
- **WHEN** система ещё использует текущие legacy runtime/level данные

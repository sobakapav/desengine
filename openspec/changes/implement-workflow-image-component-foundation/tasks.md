...
- [x] 2. Обновить task workflow projection: coordinator step `Работаем над workflow` + catalog of workflow points вместо одного `level-lab` шага.
...
- [x] Указать затронутые OpenSpec capability/scenarios: `workflow`, `workbench`, `task`, `level-labs`.

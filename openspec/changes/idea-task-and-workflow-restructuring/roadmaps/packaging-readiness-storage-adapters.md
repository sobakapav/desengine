...
`idea-task-and-workflow-restructuring` владеет этим roadmap и использует его как planning-вход для packaging ideas вместе с архитектурным roadmap из `focus-tech`.

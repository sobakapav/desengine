...
- Что из родительского change уже решено:
  ...
  - старый служебный путь больше не должен определять новый пользовательский контракт;
...
- Что сознательно не входит в этот change:
  ...
  - возврат старой служебной лексики в новый контракт.
...
- Что именно должен доказать результат проверки:
  ...
  - новый слой не возвращает старую служебную модель в пользовательский путь.

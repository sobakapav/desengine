...
- Dispatcher сейчас удерживает только цепочку `ProjectWorkspace -> component layer -> workflow -> locked workbench shell`.
...
- [ ] 3. Зафиксировать tactical ownership для:
  ...
  - [ ] 3.3 component layer внутри project context;
  - [ ] 3.4 отдельного workflow layer как процесса проектной работы;
  - [ ] 3.5 отдельного locked `workbench` / preview binding;

...
- Какие именно `tip.md` сейчас остаются с legacy-именем и нужно ли чинить только найденные level-3 traces или дополнительно искать такие упоминания в task descriptions/overview других уровней.
- Нужен ли один content-contract test по glob-поиску по onboarding level 3 или более узкий unit test на конкретный набор файлов.

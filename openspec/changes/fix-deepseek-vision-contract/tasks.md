...
- [ ] 1. Локализовать provider boundary для image-bearing DeepSeek task-flow.
- [ ] 2. Устранить silent-loss изображений:
  - [ ] 2.1 либо отправлять изображения в поддерживаемом формате;
  - [ ] 2.2 либо вводить fail-fast guard для image-dependent запросов.
- [ ] 3. Согласовать task action и system diagnostics с новым поведением.
- [ ] 4. Добавить тесты, которые фиксируют запрет на silent text-only fallback.

...
- [x] 1. Локализовать текущий источник неправильного перехода после успешного `check`.
- [x] 2. Исправить порядок экранов так, чтобы результат проверки показывался раньше следующего уровня.
- [x] 3. Проверить, что change не ломает flow последнего уровня и полного завершения задачи.
- [x] 4. Добавить browser/e2e покрытие на правильный порядок экранов после успешной проверки.

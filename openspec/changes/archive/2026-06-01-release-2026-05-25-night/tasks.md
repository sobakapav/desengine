...
- [x] 1. Зафиксировать роль `release-2026-05-25-night` как релизной метки без изменения `parent_change` у downstream integration changes.
- [x] 2. Описать состав integration-wave и связь с delivery-контуром `dispatcher-test-system`.

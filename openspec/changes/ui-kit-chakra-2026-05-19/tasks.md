...
- [ ] 1. Добавить Chakra UI в конфиг Sandpack UI kit'ов.
- [ ] 2. Добавить/обновить зависимости в `package.json` (good enough).
- [ ] 3. Добавить smoke-пример рендера Chakra-компонента в Sandpack preview.
- [ ] 4. Тесты: unit + traceability (+ e2e smoke при необходимости).
- [ ] 5. Зафиксировать команды проверки: `npm run test:unit`, `npm run test:traceability` (и `npm run test:e2e` если добавлен).

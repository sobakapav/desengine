...
- Внедрить монохромный shell-language по референсу: светлый paper background, тонкие тёмные границы, крупные serif-заголовки, uppercase eyebrow labels, спокойные отступы, прямые линии, пунктирные secondary blocks и чёрно-белую инверсию для активных элементов.
...
- Палитра:
  ...
  - продуктовый UI не использует цвет как основной язык состояний;
...
- Геометрия:
  ...
  - скругления убираются из product-shell интерфейса;
  - dashed inset допускается как secondary emphasis для поясняющих, review- или locked-блоков.
- Навигация и выбор:
